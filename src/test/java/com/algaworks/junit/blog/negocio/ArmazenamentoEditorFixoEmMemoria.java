...
// Classe Stub (Dublê ou Simulação)
public class ArmazenamentoEditorFixoEmMemoria implements ArmazenamentoEditor {
    ...
    public Optional<Editor> encontrarPorEmail(String email) {
        if (email.equals("antonio.existe@teste.com")) {
            return Optional.of(new Editor(2L, "Antonio", "antonio.existe@teste.com", BigDecimal.TEN, true));
        }
        return Optional.empty();
    }
